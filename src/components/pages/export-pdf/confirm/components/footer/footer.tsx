    ...
    <>
      ...
      <View style={styles.masterContainer}>
        ...
        <View style={styles.notaContents}>
          <Text>
            El confirmado —o su padrino (madrina)— entregará esta ficha al
            ministro
          </Text>
          <Text>
            que acompaña al Obispo (o su Delegado) en el momento de la
            imposición
          </Text>
          <Text>de las manos, pronunciando en voz alta su nombre de pila.</Text>
          <Text>
            Después de la Celebración, esta boleta debe enviarse al lugar del
            bautismo
          </Text>
